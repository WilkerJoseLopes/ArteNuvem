...
# cria tabelas ao arrancar (Postgres ou SQLite, dependendo da config)
...
@app.before_request
def fake_login():
    """Simula um utilizador logado. Futuro: trocar por Google Auth."""
...
def admin():
    """
    Admin de categorias e exposições na mesma página.
    Usa um campo hidden 'tipo_form' para saber qual parte foi submetida.
    """
    if request.method == "POST":
